...
export default function Content({
    ...
    const getInsideDefaultPosition = () : {top: number; left:number} =>{
        const generId = genre_ids[0];
        const contentsWrapper = contentsWrappersRef.current[`${generId}`]
        ...
        return {
            ...
            left: contentsWrapper.offsetLeft + contentsWrapper.offsetLeft + getSliderTranslationX(),
        };
    };
    ...
    const getYoutubeLine = (key: string): string => `https://www.youtube.com/${key}?autoplay=1&mute=1`;
