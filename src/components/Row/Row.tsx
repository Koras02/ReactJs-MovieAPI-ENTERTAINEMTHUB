...
export default function Row({
  ...
  return (
    <Styled.Container>
      ...
      <Styled.ContentsWrapper ref={(element: HTMLDivElement | null) => (contentsWrappersRef.current[`${id}`] = element)}>
        {sliderStartIndex > 0 && (
          <Styled.PrevButton
        ...
        <Styled.Slider style={getSliderStyle()} ref={(element: HTMLDivElement | null) => (slidersRef.current[`${id}`] = element)}>
